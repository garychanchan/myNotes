...
字符串，key-value结构，key是唯一标识，value可以是字符串，也可以是数字，最大长度512M
...
- String：底层结构是SDS
- List：底层结构是双向链表 or ziplist，redis3.2后，quicklist
- Hash：底层结构是ziplist or hashtable，redis7.0后，listpack or hashtable
- Set：底层结构是整数集合 or 哈希表
- Zset：底层结构是ziplist or 跳表，redis7.0后，listpack or 跳表
